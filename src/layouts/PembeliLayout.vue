    ...
    >
      <q-scroll-area class="fit">
        <q-list>
          ...
          <q-item clickable active-class="active" class="text-teal-10" exact v-ripple to="/pembeli">
          ...
          <q-item clickable active-class="active" class="text-teal-10" exact v-ripple to="/pembeli/datatransaksi">
            <q-item-section avatar>
